...
pandoc.table(round(prop_topol,2) %>% dplyr::select(Size, Links, LD, Connectance, Omnivory, PathLength, Clustering) %>% mutate(SW = "True"), col.names = c("Species","Interactions","Density","Connectance","Omnivory","CPL", "CC", "SW"), split.cells = c(1,1,1,1,1,1,1,1),
                      caption = "Network-level properties of the MPA Namuncurá - Burdwood Bank food web. CPL: Characteristic Path Length; CC: Clustering Coefficient; SW: Small-World pattern. See table 1 for definitions and ecological relevance.")
...
```{r figure2, echo=FALSE, message=FALSE, warning=FALSE, fig.width = 5.5, fig.height = 10, fig.align='center', fig.cap="Graph of the food web for the MPA Namuncurá - Burdwood Bank. Circles represent species and arrows trophic interactions. Circle diameter is relative to the number of interactions. Colour gradient indicates the trophic level."}
# Food web graph
