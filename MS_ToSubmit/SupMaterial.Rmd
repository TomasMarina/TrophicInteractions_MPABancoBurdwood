...
```{r ref_plot, echo=FALSE, message=FALSE, fig.cap="Summary of references used to build the network of trophic (predator-prey) interactions for the MPAN-BB ecosystem."}
