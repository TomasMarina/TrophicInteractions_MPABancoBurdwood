...
High-latitude marine ecosystems, such as the MPA N-BB, are characterised by an unexpected complexity in terms of biodiversity and ecological interactions [@Day2013; @Kortsch2019; @Cordone2020; @Trathan2021]. Although there is a robust knowledge about the complexity considering the richness of the benthic and plankton communities in the MPA N-BB ecosystem [e.g. @Schejter2016; @Guinder2020; @APN2022], there is a need for a better understanding of species interactions' complexity and structure.
