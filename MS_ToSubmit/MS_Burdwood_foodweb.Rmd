...
author:
  ...
  - name: Fabiana L. Capitanio^d^^,^^e^
  - name: Sergio M. Delpiani^f^
  - name: Juan Martín Díaz de Astarloa^e^
  - name: Cintia Fraysse^a^
  - name: Virginia A. García Alonso^d^^,^^e^
  - name: Andrea Raya Rey^a^^,^^c^^,^^g^
  - name: Mariela L. Spinelli^d^^,^^e^
  - name: Marcos Tatián^h^^,^^i^
  - name: Diego Urteaga^j^
...
address:
  ...
  - code: 4
    address: Facultad de Ciencias Exactas y Naturales, Universidad de Buenos Aires (UBA), Argentina
  - code: 5
...
#nocite: '@*' cites all references in .bib file
linenumbers: true
numbersections: true
...
In recent years, network approaches have been successfully applied to study complex high-latitude marine ecosystems, improving our knowledge on structure, functioning, and response to environmental/anthropogenic changes [@Kortsch2015; @Cordone2018; @Funes2022; @Marina2023]. Among anthropogenic threats, it is worth mentioning that contaminants like mercury and microplastics have been recently reported as important threats to the MPA N-BB region [@Cossi2021; @DiMauro2022; @Fioramonti2022]; also fishing vessels are allowed to operate in the western section of the MPA N-BB (i.e. Marine National Reserve category), altering the stocks of commercially important fish species [@Martinez2021; @AdministraciondeParquesNacionales2022]. Moreover, there is a potential hazard related to the effects of offshore activities (exploration and explotation) to the west of the MPA N-BB [@AdministraciondeParquesNacionales2022].
...
The MPAs Namuncurá - Burdwood Bank I and II, created by National Laws 26.875 in 2013 and 27.490 in 2017, comprise a shallow submarine plateau called Burdwood Bank (BB) and a deep slope that reaches 4000 m in depth, N-BB I and N-BB II, respectively [@Tombesi2020; @AdministraciondeParquesNacionales2022] (Figure 1). They are located 150 km east of Isla de los Estados and 200 km south of Malvinas/Falkland Islands.
The MPA N-BB I comprises nearly 34,000 km^2^ circumscribed by the 200 m isobath, between 54º–55ºS and 56º–62ºW, with a slight slope extended nearly 370 km east–west. Physical features in the BB are fairly stable, with salinity averaging 34 all year round and temperature ranging between 4 and 8ºC [@Guerrero1999; @Acha2004; @Piola2009]. The BB is surrounded by steep flanks of up to 4000 m depth through which strong currents circulate [@Piola1989; @Reta2014; @Matano2019]. The N-BB II includes such a deep slope, protecting about 32,000 km^2^. Intense upwelling and mixing occur over it, entraining deep nutrient-rich waters into the photic layer [@Piola2009; @Matano2019] and resulting in a fairly homogeneous water column both spatially and temporally [@Glorioso1995; @Guerrero1999; @Matano2019].
...
In terms of complexity, the MPA Namuncurá - Burdwood Bank food web (N-BB I and II) consisted of 1780 predator-prey interactions and 375 species, where 93% of them were defined at the species taxonomical level (Figure 2, Table S2). The food web presented a link density (e.g., the average number of interactions per species) of 4.75, and a connectance of 0.01. Almost half of the consumers were omnivores (0.48), feeding on sources at different trophic levels. The food web displayed a small-world pattern, meaning that the path length was lower and the clustering coefficient higher than the random networks (Table 2).

\newpage

```{r figure2, echo=FALSE, fig.width = 5.5, fig.height = 10, fig.align='center', fig.cap="Graph of the food web for the MPA Namuncurá - Burdwood Bank. Circles represent species and arrows trophic interactions. Circle diameter is relative to the number of interactions. Colour gradient indicates the trophic level."}
# Food web graph
...
knitr::kable(round(prop_topol,2) %>% dplyr::select(Size, Links, LD, Connectance, Omnivory, PathLength, Clustering) %>% mutate(SW = "True"), col.names = c("Species","Interactions","Density","Connectance","Omnivory","CPL", "CC", "SW"),
                      caption = "Network-level properties of the MPA Namuncurá - Burdwood Bank food web. CPL: Characteristic Path Length; CC: Clustering Coefficient; SW: Small-World pattern. See table 1 for definitions and ecological relevance.") %>% row_spec(0,bold=TRUE)
...
## The food web of the MPA Namuncurá - Burdwood Bank ecosystem
...
In summary, the food web of the MPA N-BB presents a combination of network properties that makes it unique in terms of network resolution, complexity, and structural pattern. All this suggests that the ecosystem might be fragile to external perturbations targeting highly connected species, which in turn coincides to be commercial exploited species as fishes [@Martinez2015]. However, structural properties might provide resilience and resistance with the final outcome of a rearranged structure maintaining its functions.
