...
The food web for the MPA Namuncurá - Banco Burdwood, analysed in this study, is one of the most highly-resolved networks of trophic interactions not only for a high-latitude marine ecosystem but also for a marine protected area worldwide. It is of paramount importance to consider the complexity of species interactions in order to gain insights into the structure and functioning of the ecosystem, since the aggregation of species might mask food web properties and/or generate artifacts [@Martinez1993; @Gauzens2013].
Connectance, a property that resumes the complexity of a food web, 
...
Important to attacks like anthropogenic perturbations: mercury, microplastics
As Dunne et al. (2002b) have correctly pointed out the anthropogenically caused species and population extinctions are far from being random as human have historically tended to impact higher trophic levels in the ecosystems.
