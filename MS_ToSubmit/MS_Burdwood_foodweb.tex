...
Marine Protected Area}
  ...
  %
    ...
    \author[]{To be continued(?)\textsuperscript{c}%
  %
  }
...
(CADIC-CONICET), Argentina}
    ...
    \affiliation[3]{INIDEP, UBA-CONICET, IIMyC-CONICET, MACN-CONICET,
UNC-CONICET}
...
the present research (add names if necessary), and special thanks to GA
Lovrich the Scientific Coordinator of the MPA Namuncurá-Burdwood Bank
and the MPA N-BB Administrators. This study was funded by Consejo
Nacional de Investigaciones Científicas y Técnicas (CONICET) and Agencia
Nacional de Promoción Científica y Tecnológica (PICT 2020-SERIEA-01617),
Argentina. This work is contribution no. XX of the MPA Namuncurá (Law
26.875).
