...
Universidad Nacional de Córdoba (UNC), Argentina}
  ...
  associated to oceanic islands, except for the MPAs Namuncurá - Banco
  Burdwood I and II (MPA N-BB, 53º--55ºS and 56º--62ºW, respectively),
  which are associated to a submarine plateau and its southern adjacent
  deep slope region, respectively. Here, we present the first detailed
  analysis of the network of predator-prey interactions (food web) for
  the MPA N-BB ecosystem. We applied a network approach to characterize
  the food web in terms of complexity and structure, and identifying the
  species' role in such a framework. In terms of complexity, the MPA
  N-BB food web consisted of 1778 predator-prey interactions and 379
  species, with a link density of 4.69 and a connectance of 0.01. In
  terms of structure, almost half of the consumers were omnivores
  (0.48), and the network displayed a small-world pattern. These
  findings suggest that the ecosystem might be vulnerable to external
  perturbations targeting highly connected species, although structural
  properties might provide resilience and resistance, resulting in a
  rearranged structure that preserves its original functions.
  Furthermore, we identified several species as important in terms of
  different aspects of trophic structure and functioning, and response
  to perturbations. We suggest that generalist species, mainly fishes,
  play a crucial role in the ecosystem's bentho-pelagic coupling
  process. In addition, we propose that other species besides the
...
and structure is needed. This aspect can be tackled by analyzing one of
...
preys (Figure 3B). The top-five predators in number of prey were:
...
3C). The top-five prey in number of predators were: Detritus
...
into account the interactions within each functional group, most
...
\emph{Pteraster sp} (echinoderms), \emph{Phalacrocorax atriceps} and
...
Dinoflagellates, Echinodermata, fish (bentho-pelagic and demersal
Osteichthyes, and Chondrychthyes), Foraminifera, Polychaeta, Porifera,
Pycnogonida, sea birds, and zooplankton (see Supplementary Material
Table S3 for the identity of the species).
...
local extinction) throughout the network and, at the same time, more
...
N-BB either has a narrow diet or are specialists, while few present a
...
(Raya Rey, 2022; Riccialdelli, 2022).
...
pelagic animals such as marine mammals and sea birds arise as relevant,
...
As a consequence most of the data we used to build the network come from
studies performed in the MPA N-BB I. Despite this fact, we decided to
build the food web considering both MPAs due to the tight oceanographic
and ecological connection that exists among them (references in APN,
2022).
...
Alonso et al., 2018; Matano et al., 2019). Although we were aware of it,
we decided to characterize a food web representing the whole MPA N-BB I
...
Incorporate habitat heterogeneity, since the benthic community in the BB
and deep flanks differs {[}; Schejter \& Albano (2021){]}. This
heterogeneity might lead to distinct food web properties, hence
differences in ecosystem functioning and response to anthropogenic and
environmental perturbations (Cordone et al., 2020; Kortsch et al.,
2019). El caso de las ascidias (Tatián)

Incorporate species traits, like body size and mass, which are known to
be important drivers in predator-prey interactions. La Mesa et al.
(2016)
...
\leavevmode\vadjust pre{\hypertarget{ref-Belleggia2019}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-AlvarezColombo2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Dellabianca2015}{}}%
Dellabianca, N. A. (2015). \emph{{Informe de Campaña {``Namuncurá-Banco
Burdwood''}}} (p. 48) {[}\{Field campaign Report\}{]}.

\leavevmode\vadjust pre{\hypertarget{ref-Dellabianca2018}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Giberto2017}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Ospina-Alvarez2020}{}}%
...
\leavevmode\vadjust pre{\hypertarget{ref-Schejter2017}{}}%
