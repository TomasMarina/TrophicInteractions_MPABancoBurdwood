...
(IIMYC), Universidad Nacional de Mar del Plata-CONICET, Argentina}
    ...
    \affiliation[6]{Instituto de Biodiversidad y Biologia Experimental y
...
Rivadavia'', Argentina}
    \affiliation[8]{Instituto de Diversidad y Ecologia Animal
(IDEA-CONICET)}
...
Universidad Nacional de Cordoba (UNC), Argentina}
  ...
  the MPA N-BB ecosystem. We applied a network approach to characterise
  ...
  N-BB food web consisted of 1780 predator-prey interactions and 375
  species, with a link density of 4.75 and a connectance of 0.01. In
  ...
  play a crucial role in the ecosystem's bentho-pelagic coupling process
  and that other species, besides the longtail southern cod
  ...
  ecosystem. Finally, we argue that the diversity of species, including
  both the benthic and pelagic habitats, is responsible for seccuring
  the connectivity within the food web against perturbations, therefore
