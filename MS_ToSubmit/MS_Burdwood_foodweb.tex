...
oceanic Marine Protected Area}
  ...
  %
    ...
    \author[]{Diego Urteaga\textsuperscript{j}%
  %
  }
...
(IIMYC), Universidad Nacional de Mar del Plata-CONICET, Argentina}
    ...
    \affiliation[8]{Facultad de Ciencias Exactas, Fisicas y Naturales,
Universidad Nacional de Cordoba (UNC), Argentina}
    \affiliation[9]{Instituto de Diversidad y Ecologia Animal
(IDEA-CONICET)}
    \affiliation[10]{Museo Argentino de Ciencias Naturales ``Bernardino
Rivadavia'', Argentina}
  ...
  Burdwood Bank I and II (MPA N-BB, 53º--55ºS and 56º--62ºW,
  respectively), which are associated to a submarine plateau and its
  southern adjacent deep slope region, respectively. Here, we present
  the first detailed analysis of the network of predator-prey
  ...
  In terms of complexity, the MPA N-BB food web consisted of 1780
  predator-prey interactions and 375 species, with a link density of
  4.75 and a connectance of 0.01. In terms of structure, almost half of
  ...
  species, although structural properties might provide resilience and
...
2020; Vazquez et al., 2018). The maintenance of this singular community
is related to local and regional oceanographic processes, including the
...
(Guinder et al., 2020). Overall, 811 benthic and plankton species have
been identified for the MPA N-BB ecosystem, where 349 were reported for
the first time in the area in recent years (Administracion de Parques
Nacionales, 2022). However, identifying the main species involved in the
...
MPA N-BB ecosystem (Administracion de Parques Nacionales, 2022; Guinder
...
species (Administracion de Parques Nacionales, 2022; Martínez et al.,
...
N-BB (Administracion de Parques Nacionales, 2022).
...
N-BB I and N-BB II, respectively (Administracion de Parques Nacionales,
2023; Tombesi et al., 2020) (Figure 1). They are located 150 km east of
...
(references in Administracion de Parques Nacionales, 2022), a joint
management plan was recently proposed (Administracion de Parques
...
I and II) consisted of 1780 predator-prey interactions and 375 species,
...
number of interactions per species) of 4.75, and a connectance of 0.01.
...
exists among them (Administracion de Parques Nacionales, 2022 and
references therein).
...
Administracion de Parques Nacionales. (2022). \emph{Plan de gestión {AMP
Namuncurá Banco Burdwood}}.

\leavevmode\vadjust pre{\hypertarget{ref-AdministraciondeParquesNacionales2023}{}}%
Administracion de Parques Nacionales. (2023). \emph{Área {Marina
...
Namuncurá Banco Burdwood: Aspectos físicos y biogeoquímicos}}.
