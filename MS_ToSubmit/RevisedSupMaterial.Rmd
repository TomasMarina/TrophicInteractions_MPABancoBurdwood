...
pandoc.table(int_good_res %>% arrange(., (Predator)) %>% mutate(Reference_link = paste('\\tiny', Reference_link), Reference = paste('\\tiny', Reference), Prey = paste('\\tiny', Prey), Predator = paste('\\tiny', Predator)), style="multiline", split.tables = Inf, justify = c("left","left","center","right"),
