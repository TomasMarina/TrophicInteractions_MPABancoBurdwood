...
knitr::kable(int_good_res %>% arrange(., (Predator)), booktabs = TRUE, format = "latex", longtable = T, col.names = c("Prey","Predator","Reference", "Link"), caption = "List of predator-prey (trophic) interactions used to build the network for the Marine Protected Area Namuncurá - Banco Burdwood I ecosystem (MPAN-BB).") %>% 
...
knitr::kable(sp_list, format = "latex", booktabs = TRUE, linesep = "", longtable = TRUE, col.names = c("Species","Group","Reference","Link","Observation"), caption = "List of species for the food web of the Marine Protected Area Namuncurá - Banco Burdwood I ecosystem (MPAN-BB).") %>%
...
Figure 2 shows the species topological roles of the food web for the MPA Namuncurá-Banco Burdwood ecosystem. Species, represented by circles, are coloured by role: network connector (dark purple), module connector (light pink), module hub (light green), and module specialist (dark green). Network connector = 5 species; module connector = 35 species; module hub = 7 species; and module specialist = 332 species.

```{r toprole, echo=FALSE, fig.width = 20, fig.height=20, fig.cap="Graph of the food web showing species coloured by topological role: network connector (dark purple), module connector (light pink), module hub (light green), and module specialist (dark green)."}
