...
knitr::kable(int_good_res %>% arrange(., (Predator)), booktabs = TRUE, format = "latex", longtable = T, col.names = c("Prey","Predator","Reference", "Link"), caption = "List of predator-prey (trophic) interactions for the food web of the Marine Protected Area Namuncurá - Banco Burdwood I ecosystem.") %>% 
...
knitr::kable(sp_list, format = "latex", booktabs = TRUE, linesep = "", longtable = TRUE, col.names = c("Species","Group","Reference","Link","Observation"), caption = "List of species for the food web of the Marine Protected Area Namuncurá - Banco Burdwood I ecosystem.") %>%
...
knitr::kable(spp_total %>% 
             ...
             format = "latex", booktabs = TRUE, linesep = "", longtable = TRUE, col.names = c("Species","Group","Degree","NumPrey","NumPred","Between","Close","TL","TS","TR"), align = "llcccccccc", caption = "Species-level properties for the food web of the Marine Protected Area Namuncurá - Banco Burdwood I ecosystem. Degree: total number of interactions; Between: betweenness; Close: closeness; TL: trophic level; TS: trophic similarity; TR: topological role (netcon = network connector, modcon = module connector, modhub = module hub, modspe = module specialist).") %>%
