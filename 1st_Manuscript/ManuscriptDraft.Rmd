...
We analyzed the MPA Namuncurá-Banco Burdwood network of trophic interactions, hereafter food web, at two levels: 1) global, considering species and interactions of the entire network; and 2) species, considering interactions and species related to a particular species.
...
```{r figure2, echo=FALSE, fig.align='center', fig.cap="Graph of the food web of MPA Namuncurá-Banco Burdwood. Circles represent the species and arrows the trophic interactions. Colour gradient indicate the trophic level. Circle diameter is relative to the number of interactions."}
# Food web graph
...
```{r figure3, echo=FALSE, fig.height = 28, fig.width = 20, fig.cap="Degree distributions for the (A) food web, for (B) prey among predators, (C) predators among prey, and (D) for each functional group."}
...
grid.newpage()
# Arrange figure
figure_5 <- plot_troph_level(g_up_c, vertexLabel = F, modules = F, ylab = "Trophic level", vertex.color = V(g_up_c)$TRColor)
